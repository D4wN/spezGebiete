...
http.createServer(function (req, res) {
...

    {
        ...
        (function () {
            ...
            var myGenerator = regeneratorRuntime.mark(function callee$2$0(t) {
                return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                        case 0:
                            ...
                            return context$3$0.delegateYield(myGenerator(t.left), "t0", 2);
                        ...
                        case 4:
                            return context$3$0.delegateYield(myGenerator(t.right), "t1", 5);
    ...
    //REST Parameters
    {
        ...
        var _res = [];
        push(_res, "START", 1, 2, 3, 4, 5, "ENDE");
...

    {
        ...
        (function () {
            var fakOfString = regeneratorRuntime.mark(function callee$2$0(path) {
                var total, count, i;
                return regeneratorRuntime.wrap(function callee$2$0$(context$3$0) {
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                        case 0:
                            //fakultaet of String size
                            console.log(path + "");
                            total = 0;
                            count = 0;
                            ...
                            return context$3$0.abrupt("return", total);
            ...
            var lineFaks = regeneratorRuntime.mark(function callee$2$1() {
                var total;
                return regeneratorRuntime.wrap(function callee$2$1$(context$3$0) {
                    while (1) switch (context$3$0.prev = context$3$0.next) {
                        case 0:
                            total = 0;
                            return context$3$0.delegateYield(fakOfString("../src"), "t2", 2);

                        case 2:
                            total += context$3$0.t2;
                            return context$3$0.delegateYield(fakOfString("../data"), "t3", 4);

                        case 4:
                            total += context$3$0.t3;
                            return context$3$0.delegateYield(fakOfString("../lib"), "t4", 6);

                        case 6:
                            total += context$3$0.t4;
            ...
            try {
                ...
                for (_iterator4 = lineFaks()[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    var i = _step4.value;
                }
            } catch (err) {
